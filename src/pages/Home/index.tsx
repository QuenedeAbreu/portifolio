      ...
      <div className="w-screen 
        ...
        <div className=" w-full flex" style={{ height: "calc(100vh - 4rem)" }}>
          <div className=" sm:w-1/5 w-1/5 flex items-end">
            <div className="w-auto list-social absolute -left-6 sm:left-16 md:left-2">
              <ul className="list-none ml-11 mb-11">
                <li className=""><a href="https://www.linkedin.com/in/quenede-abreu-928693203/"><AiFillLinkedin className="text-white text-2xl mb-5 hover:text-[#888] transition-all duration-500" /></a></li>
                <li><a href="https://www.facebook.com/quenede.abreu/"><AiFillFacebook className="text-white text-2xl mb-5 hover:text-[#888] transition-all duration-500" /></a></li>
                <li><a href="mailto:quenede.in@gmail.com"><SiGmail className="text-white text-2xl mb-5 hover:text-[#888] transition-all duration-500" /></a></li>
                <li><a href="https://github.com/QuenedeAbreu"><AiFillGithub className="text-white text-2xl hover:text-[#888] transition-all duration-500" /></a></li>
              </ul>
            </div>
          </div>
          <div className=" sm:w-4/5 w-4/5 flex items-center">
            <div className=" sm:w-3/4 sm:h-2/4  infos">
              ...
              <div className=" sm:w-full sm:h-[40%] flex items-center">
                <h1 className="uppercase text-white font-oswald sm:font-extrabold sm:text-6xl ">full stack developer</h1>
              </div>
              ...
              <div className=" sm:w-full sm:h-[20%] flex items-end ">
                <a href="https://api.whatsapp.com/send?phone=5568999655360&text=Oi%20Quenede!%20Queria%20fazer%20um%20or%C3%A7amento." className="relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-bold group">
                  ...
                  <span className="relative w-full text-left text-[#838383] transition-colors duration-200 ease-in-out group-hover:text-gray-900 flex items-center font-oswald"> <AiOutlineWhatsApp className="mr-3" /> CONTACT ME</span>
                  <span className="absolute inset-0 border border-[#838383]"></span>
                </a>
              </div>
            </div>
          </div>
